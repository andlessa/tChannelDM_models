...
Decay_b = Decay(name = 'Decay_b',
                ...
                partial_widths = {(P.W__minus__,P.t):'(((3*ee**2*MB**2)/(2.*sw**2) + (3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MB**4)/(2.*MW**2*sw**2) - (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MB)**3)',
                                  (P.Xs,P.YFd):'((3*MB**2*yFbR**2 - 3*MX**2*yFbR**2 + 3*MYd**2*yFbR**2)*cmath.sqrt(MB**4 - 2*MB**2*MX**2 + MX**4 - 2*MB**2*MYd**2 - 2*MX**2*MYd**2 + MYd**4))/(96.*cmath.pi*abs(MB)**3)'})
...
Decay_t = Decay(name = 'Decay_t',
                ...
                partial_widths = {(P.W__plus__,P.b):'(((3*ee**2*MB**2)/(2.*sw**2) + (3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MB**4)/(2.*MW**2*sw**2) - (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.Xs,P.YFu):'((3*MT**2*yFtR**2 - 3*MX**2*yFtR**2 + 3*MYu**2*yFtR**2)*cmath.sqrt(MT**4 - 2*MT**2*MX**2 + MX**4 - 2*MT**2*MYu**2 - 2*MX**2*MYu**2 + MYu**4))/(96.*cmath.pi*abs(MT)**3)'})
...
Decay_Xs = Decay(name = 'Decay_Xs',
                 particle = P.Xs,
                 partial_widths = {(P.b,P.YFd__tilde__):'((-3*MB**2*yFbR**2 + 3*MX**2*yFbR**2 - 3*MYd**2*yFbR**2)*cmath.sqrt(MB**4 - 2*MB**2*MX**2 + MX**4 - 2*MB**2*MYd**2 - 2*MX**2*MYd**2 + MYd**4))/(16.*cmath.pi*abs(MX)**3)',
                                   ...
                                   (P.t,P.YFu__tilde__):'((-3*MT**2*yFtR**2 + 3*MX**2*yFtR**2 - 3*MYu**2*yFtR**2)*cmath.sqrt(MT**4 - 2*MT**2*MX**2 + MX**4 - 2*MT**2*MYu**2 - 2*MX**2*MYu**2 + MYu**4))/(16.*cmath.pi*abs(MX)**3)',
                                   (P.u,P.YFu__tilde__):'((MX**2 - MYu**2)*(3*MX**2*yFqR**2 - 3*MYu**2*yFqR**2))/(16.*cmath.pi*abs(MX)**3)',
                                   (P.YFd,P.b__tilde__):'((-3*MB**2*yFbR**2 + 3*MX**2*yFbR**2 - 3*MYd**2*yFbR**2)*cmath.sqrt(MB**4 - 2*MB**2*MX**2 + MX**4 - 2*MB**2*MYd**2 - 2*MX**2*MYd**2 + MYd**4))/(16.*cmath.pi*abs(MX)**3)',
                                   ...
                                   (P.YFu,P.t__tilde__):'((-3*MT**2*yFtR**2 + 3*MX**2*yFtR**2 - 3*MYu**2*yFtR**2)*cmath.sqrt(MT**4 - 2*MT**2*MX**2 + MX**4 - 2*MT**2*MYu**2 - 2*MX**2*MYu**2 + MYu**4))/(16.*cmath.pi*abs(MX)**3)',
                                   (P.YFu,P.u__tilde__):'((MX**2 - MYu**2)*(3*MX**2*yFqR**2 - 3*MYu**2*yFqR**2))/(16.*cmath.pi*abs(MX)**3)'})

Decay_YFd = Decay(name = 'Decay_YFd',
                  particle = P.YFd,
                  partial_widths = {(P.Xs,P.b):'((3*MB**2*yFbR**2 - 3*MX**2*yFbR**2 + 3*MYd**2*yFbR**2)*cmath.sqrt(MB**4 - 2*MB**2*MX**2 + MX**4 - 2*MB**2*MYd**2 - 2*MX**2*MYd**2 + MYd**4))/(96.*cmath.pi*abs(MYd)**3)',
...
Decay_YFu = Decay(name = 'Decay_YFu',
                  ...
                  partial_widths = {(P.Xs,P.c):'((-MX**2 + MYu**2)*(-3*MX**2*yFqR**2 + 3*MYu**2*yFqR**2))/(96.*cmath.pi*abs(MYu)**3)',
                                    (P.Xs,P.t):'((3*MT**2*yFtR**2 - 3*MX**2*yFtR**2 + 3*MYu**2*yFtR**2)*cmath.sqrt(MT**4 - 2*MT**2*MX**2 + MX**4 - 2*MT**2*MYu**2 - 2*MX**2*MYu**2 + MYu**4))/(96.*cmath.pi*abs(MYu)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.YFd,P.YFd__tilde__):'(((8*ee**2*MYd**2*sw**2)/(3.*cw**2) + (4*ee**2*MZ**2*sw**2)/(3.*cw**2))*cmath.sqrt(-4*MYd**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.YFu,P.YFu__tilde__):'(((32*ee**2*MYu**2*sw**2)/(3.*cw**2) + (16*ee**2*MZ**2*sw**2)/(3.*cw**2))*cmath.sqrt(-4*MYu**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)'})
