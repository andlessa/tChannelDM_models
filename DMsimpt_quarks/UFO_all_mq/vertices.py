...
V_50 = Vertex(name = 'V_50',
              ...
              couplings = {(0,0):C.GC_105,(0,1):C.GC_128})

V_51 = Vertex(name = 'V_51',
              particles = [ P.u__tilde__, P.d, P.G__plus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_113,(0,1):C.GC_136})

V_52 = Vertex(name = 'V_52',
              particles = [ P.c__tilde__, P.s, P.G__plus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_125,(0,1):C.GC_108})
...
V_68 = Vertex(name = 'V_68',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_109,(0,1):C.GC_124})

V_69 = Vertex(name = 'V_69',
              particles = [ P.b__tilde__, P.t, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_129,(0,1):C.GC_104})

V_70 = Vertex(name = 'V_70',
              particles = [ P.d__tilde__, P.u, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_137,(0,1):C.GC_112})
