...
V_10 = Vertex(name = 'V_10',
              particles = [ P.G0, P.G0, P.Xs, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_24})

V_11 = Vertex(name = 'V_11',
              particles = [ P.G__minus__, P.G__plus__, P.Xs, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_24})

V_12 = Vertex(name = 'V_12',
              particles = [ P.H, P.H, P.Xs, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_24})

V_13 = Vertex(name = 'V_13',
              particles = [ P.H, P.Xs, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
              couplings = {(0,0):C.GC_55})

V_14 = Vertex(name = 'V_14',
              particles = [ P.Xs, P.Xs, P.Xs, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
...
V_52 = Vertex(name = 'V_52',
              particles = [ P.YF__tilde__, P.e__minus__, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_71})

V_53 = Vertex(name = 'V_53',
              particles = [ P.YF__tilde__, P.mu__minus__, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_72})

V_54 = Vertex(name = 'V_54',
              particles = [ P.YF__tilde__, P.ta__minus__, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_73})

V_55 = Vertex(name = 'V_55',
              particles = [ P.e__plus__, P.YF, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS4 ],
              couplings = {(0,0):C.GC_71})

V_56 = Vertex(name = 'V_56',
              particles = [ P.mu__plus__, P.YF, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS4 ],
              couplings = {(0,0):C.GC_72})

V_57 = Vertex(name = 'V_57',
              particles = [ P.ta__plus__, P.YF, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS4 ],
              couplings = {(0,0):C.GC_73})
...
V_74 = Vertex(name = 'V_74',
              ...
              color = [ '1' ],
              lorentz = [ L.VVV1, L.VVV2, L.VVV4, L.VVV6, L.VVV7, L.VVV8 ],
              couplings = {(0,0):C.GC_35,(0,1):C.GC_34,(0,2):C.GC_34,(0,3):C.GC_35,(0,4):C.GC_35,(0,5):C.GC_34})
